...
public class YearsCountCalcTest {
    ...
    void shouldEqualCountOfCurrentYearWithEmptyPreviousTwoYears() {
        ...
        CardTokenData.YearsData yearsDataForCurrentYear = CardTokenDataUtils.getYearsData(monthSum, monthCount, monthNumber);
        yearsDataMap.put(LocalDateTime.now().getYear(), yearsDataForCurrentYear);

        assertEquals(monthCount * monthNumber, YearsCountCalc.getCountYears(yearsDataMap, YearsOffset.current_with_two_last_years.getValue()));
    }
    ...
    void shouldEqualCountOfCurrentYearWithEmptyPreviousYear() {
        ...
        assertEquals(monthCount * monthNumber, YearsCountCalc.getCountYears(yearsDataMap, YearsOffset.current_with_last_years.getValue()));
    }
    ...
    void shouldEqualCountOfCurrentYear() {
        ...
        assertEquals(monthCount * monthNumber, YearsCountCalc.getCountYears(yearsDataMap, YearsOffset.current_year.getValue()));
    }
    ...
    void shouldEqualCountOfTwoPreviousAndCurrentYears() {
        ...
        int monthNumber = LocalDateTime.now().getMonthValue();
        CardTokenData.YearsData yearsDataForCurrentYear = CardTokenDataUtils.getYearsData(monthSum, monthCount, monthNumber);
        CardTokenData.YearsData yearsDataForPreviousYear = CardTokenDataUtils.getYearsData(monthSum, monthCount, 12);
        CardTokenData.YearsData yearsDataForSecondPreviousYear = CardTokenDataUtils.getYearsData(monthSum, monthCount, 12);
        yearsDataMap.put(LocalDateTime.now().getYear(), yearsDataForCurrentYear);
        ...
        assertEquals(expectedCount, YearsCountCalc.getCountYears(yearsDataMap, YearsOffset.current_with_two_last_years.getValue()));
    }
